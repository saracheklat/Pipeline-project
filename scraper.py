...
# OUverture du fichier config.json
with open("config.json", "r", encoding="utf-8") as f: 
    CONFIG = json.load(f)  #load convertit le contenu json en un dictionnaire Python stocké dans CONFIG 

DOWNLOAD_DIR = CONFIG["download_dir"]  # indiquer à firefox ou enregistrer les fichiers téléchargés automatiquement
COURSE_NAME = CONFIG["course_name"]    # naviguer vers le bon cours sur UniversiTice 
