...
import hashlib
import json
from emailer import send_email  # On utilise la fonction générique !
...
def main(zip_path, ref_file, mail_path):
    ...
    # --- ENVOI DES MAILS D'AVERTISSEMENT (format incorrect)
    ...
    # --- PARTAGE SUR GOOGLE SHEET
    sheet_link = csv_to_google_sheet(RESULTS_FILE)

    # --- ENVOI DU LIEN GOOGLE SHEET (bons dépôts)
